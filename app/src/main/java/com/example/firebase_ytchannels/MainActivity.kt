...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var channel1: ArrayList<Channels>
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        return when(item.itemId) {
            R.id.edit_channel -> {
                channel = channel1[info1.position] // position of array
            ...
            R.id.delete_channel -> {
                if(channelHandler.delete(channel1[info1.position])){
    ...
    override fun onStart() {
        ...
        channelHandler.channelsRef.orderByChild("rank").addValueEventListener(object:
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val adapter = ArrayAdapter<Channels>(applicationContext, android.R.layout.simple_list_item_1, channel1)
